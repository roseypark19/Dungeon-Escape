                ...
                for (var col = 0; col < level[row].length; col++) {
                    ...
                    if (code !== 0) {
                        if (i < 2) { // a map tile
                            ...
                            let top = row - 1 >= 0 ? level[row - 1][col][i] !== 1 : true;
                            let bottom = row + 1 <= level.length - 1 ? level[row + 1][col][i] !== 1 : true;
                            let left = col - 1 >= 0 ? level[row][col - 1][i] !== 1 : true;
                            let right = col + 1 <= level[0].length - 1 ? level[row][col + 1][i] !== 1 : true;
                            if (code === 1) {
